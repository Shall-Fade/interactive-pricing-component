<template>
  <div class="pricing-card-container">
    <div class="tariff-block">
      <p class="pageviews">{{ pageviewsValue }} pageviews</p>
    ...
    <div class="period-block">
      <p class="period-paragraph">Monthly Billing</p>
      <label class="period-checkbox-group">
        <input @click="togglePeriod" class="period-checkbox" type="checkbox" />
    ...
    <div class="submit-block">
      ...
      <button class="pricing-btn">Start my trial</button>
    </div>
  </div>
</template>
...
export default {
  setup() {
    ...
    const finalPrice = ref(8);
    const rowPrice = ref(8);
    ...
    function updatePageviews() {
      if (rangeValue.value == 1) {
        pageviewsValue.value = "10K";
      } else if (rangeValue.value == 2) {
        pageviewsValue.value = "50K";
      } else if (rangeValue.value == 3) {
        pageviewsValue.value = "100K";
      } else if (rangeValue.value == 4) {
        pageviewsValue.value = "500K";
      } else if (rangeValue.value == 5) {
        pageviewsValue.value = "1M";
      }
    }
